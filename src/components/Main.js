...
function Main(props) {
    ...
    return ( <
        ...
        className = "profile__avatar-button" > < img className = "profile__pencil-img"
        src = { Pencil }
        /></button >
        <
        /div>  <
        ...
        className = "profile__add-button" > < img className = "profile__plus-img"
        src = { Plus }
        alt = "Кнопка" / > < /button>  < /
        section >
