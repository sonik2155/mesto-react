...
function Card(props) {
    ...
    return (
         <>
            <img className="element__pic" src={props.element.link} alt={props.element.name} /> 
            <div className="element__container" onClick={handleClick}>
                <button type="button" className="element__delete"><img src={Trash} alt="Кнопка" /></button> 
    <h2 className="element__title">{props.element.name}</h2> 
                <div className="element__like-zone"> 
                <button type="button" className="element__like"><img src={like} alt="Лайк" /></button> 
